...
describe("PdfAdapter", () => {
  ...
  describe("generateBuffer", () => {
    ...
    it("should create multiple pages for long resumes", async () => {
      const longDescription = "This is a very long description that should force the PDF to create multiple pages. ".repeat(50);
      const resume = {
        id: "resume-123",
        userId: "user-456",
        ...
        sections: {
          ...
          education: [
            {
              school: "University of Long Names",
          ...
          certifications: [
            { name: "Very Long Certification Name That Should Take Multiple Lines", issuer: "International Association of Long Certification Names", date: "2023" }
          ],
          projects: [
            { name: "Extremely Long Project Name That Definitely Should Wrap", description: longDescription }
          ],
