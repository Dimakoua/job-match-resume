<template>
  <header class="mb-6 border-l-4 pl-4" :style="{ borderColor: style.accentColor }">
    ...
    <p class="text-lg font-medium mb-2" :style="{ color: style.accentColor }" v-html="resume.title || 'Professional Title'"></p>
