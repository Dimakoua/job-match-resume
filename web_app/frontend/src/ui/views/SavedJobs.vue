                        ...
                        <div v-for="job in filteredJobs" :key="job.id"
                            ...
                            <div class="flex justify-between items-start">
                                ...
                                <div class="flex h-6 items-center justify-center rounded-full px-3" :class="statusClass(job.status)">
                                    <select v-model="job.status" @change="updateStatus(job)" class="bg-transparent border-0 text-[10px] font-bold uppercase tracking-wider outline-none cursor-pointer appearance-none">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button @click="openTailoringStudio(job)"
                                    ...
                                    <span class="truncate">Tailor Resume</span>
                                </button>
                            </div>
                        </div>
                    </div>
